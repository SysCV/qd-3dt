...
class CustomDataset(Dataset):
    ...
    def __init__(self,
        ...
        # with 3d information (alpha, dim, location) or
        ...
        # auto augment
        self.aug_policies = aug_policies
    ...
    def prepare_train_img(self, idx):
        ...
        gt_masks = ann['masks'] if self.with_mask else None
        if self.with_seg:
        ...
        if self.aug_policies is not None:
            img, gt_bboxes, gt_masks, gt_seg = auto_augment(
                img, gt_bboxes, gt_masks, gt_seg, self.aug_policies)
