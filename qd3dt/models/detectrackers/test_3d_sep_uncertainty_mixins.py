...
from qd3dt.core import (bbox2roi, bbox_mapping, merge_aug_proposals,
...
class BBoxTestMixin(object):
    ...
    def aug_test_bboxes(self, feats, img_metas, proposal_list, rcnn_test_cfg):
        ...
        for x, img_meta in zip(feats, img_metas):
            ...
            cls_score, bbox_pred = \
                self.bbox_head(roi_feats)
            depth_pred, dim_pred, alpha_pred, cen_2d_pred = \
                self.bbox_3d_head(roi_feats)
            bboxes, scores, depths, dims, alphas, cen_2d_preds = \
                self.bbox_3d_head.get_det_bboxes(
                    rois,
                    cls_score,
                    bbox_pred,
