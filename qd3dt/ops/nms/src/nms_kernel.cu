...
__global__ void nms_kernel(const int n_boxes, const float nms_overlap_thresh, const float *dev_boxes,
...
at::Tensor nms_cuda(const at::Tensor boxes, float nms_overlap_thresh) {
    ...
    mask_dev = (unsigned long long *)c10::cuda::CUDACachingAllocator::raw_alloc(boxes_num * col_blocks *
    ...
    AT_CUDA_CHECK(cudaMemcpy(&mask_host[0], mask_dev, sizeof(unsigned long long) * boxes_num * col_blocks,
