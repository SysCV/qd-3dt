...
test_cfg = dict(
    ...
    track=dict(
        ...
        lstm_name='VeloLSTM',
        lstm_ckpt_name=
        './checkpoints/batch128_min10_seq10_dim7_train_pred_world_fixed_VeloLSTM_gta_100_linear.pth',
...
data = dict(
    ...
    train=dict(
        type=dataset_type,
        ann_file=dict(VID=data_root + 'anns/tracking_train_10percent.json'),
        img_prefix=dict(VID=data_root + 'train/image/'),
        img_scale=(1920, 1088),
    ...
    val=dict(
        ...
        #ann_file=dict(VID=data_root + 'anns/tracking_mini.json'),
        img_prefix=dict(VID=data_root + 'val/image/'),
        img_scale=(1920, 1088),
        img_norm_cfg=img_norm_cfg,
        size_divisor=32,
        flip_ratio=0,
    ...
    test=dict(
        ...
        img_prefix=dict(VID=data_root + 'test/image/'),
        img_scale=(1920, 1088),
        img_norm_cfg=img_norm_cfg,
        size_divisor=32,
        flip_ratio=0,
